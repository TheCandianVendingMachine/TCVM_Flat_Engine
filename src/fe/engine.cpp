...
void fe::engine::registerLua()
    ...
    return 0 
        ...
        m_scriptManager->getUserTypeHandler().addCustomType<scriptObject>(
            ...
            "moveToPosition", sol::overload(sol::resolve<void(float, float)>(&scriptObject::scriptObjectMoveToPosition), sol::resolve<void(fe::Vector2d)>(&scriptObject::scriptObjectMoveToPosition)),
