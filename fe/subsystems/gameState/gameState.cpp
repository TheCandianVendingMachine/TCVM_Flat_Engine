...
void fe::baseGameState::removePanel(fe::guid panel)
    {
        m_guiPanels.erase(std::remove_if(m_guiPanels.begin(), m_guiPanels.end(), [&panel](fe::gui::panel *panelPtr) { return panelPtr->id() == panel; }), m_guiPanels.end());
    }
